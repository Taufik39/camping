...
$stmt = $pdo_conn->prepare("SELECT * FROM bio_menyewakan DESC");
$stmt->execute();
      ...
      <div class="container">
        <nav class="navbar">
          <div class="navbar-header">
            ...
            <h3 style="color: aliceblue;">|| Seping</h3>
          </div>
        ...
        <div class="row">
          <div class="col-lg-6 header__title">
            <h1>DISCOVER <br> YOUR <br> CAMPING <br> ITEMS </h1>
          </div>
          <div class="col-lg-6 header__content">
            <h3 class="title"><br> GO CAMPING<br>UNDER THE NIGHT SKY</h3>
            <p>Saatnya alat campingmu disewakan untuk menyenangkan hati dan pikiran orang lain. Sewakan peralatan campingmu di sini..</p>
            <a class="header__button" href="viewmitra.php">DISCOVER</a>
          </div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        <div class="page-section">
          <div class="text-center">
            ...
            <p class="page-section__subtitle">Di bawah ini adalah testimoni pelanggan yang telah menyewa peralatan <br> camping di Seping</p>
          </div>
          <div class="row">
            <div class="col-md-8">
              <div class="accordion-group">
                <div class="collapse in indent" id="one">
                  <div class="collapse__wrapper">
                    ...
                    <p class="paragraph">Pesan di sini sungguh sangat menyenangkan, webnya sangat mudah dipahami dan juga barang yang disewa juga memuaskan.  </p>
                  </div>
                </div>
                <div class="collapse" id="two">
                  <div class="collapse__wrapper">
                    ...
                    <p class="paragraph">Well, saya senang karena mengetahui web ini dapat menyediakan pemesanan barang untuk camping. Tanpa susah-susah untuk membeli yang baru. </p>
                  </div>
                </div>
                <div class="collapse" id="three">
                  <div class="collapse__wrapper">
                    ...
                    <p class="paragraph"> Untuk barang yang dipesan sangat layak untuk dipakai dan juga pesan di sini termasuk murah dan efektif karena dapat langsung diantar ke lokasi camping </p>
                  </div>
                </div>
                <div class="collapse" id="four">
                  <div class="collapse__wrapper">
                    ...
                    <p class="paragraph"> Untuk saya yang suka travelling dan camping dan ingin menikmati gunung di Kalimantan tanpa perlu membeli yang baru sungguh sangat senang karena web ini menyediakan penyewaan perlawan camping yang baik dan layak pakai. </p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row gutters-80">
            ...
            <div class="col-md-4">
              <div class="thumbnail team__single">
                ...
                <div class="caption">
                  <h4>Website ini dibuat untuk menyelesaikan tugas dari cloud computing dan juga bisa belajar mengenai cloud computing</h4>
                  <div class="social-icons">
                    <li><a href="#"><i class="flaticon-facebook-letter-logo"></i></a></li>
                    <li><a href="#"><i class="flaticon-twitter-logo-silhouette"></i></a></li>
                    <li><a href="#"><i class="flaticon-google-plus"></i></a></li>
            ...
            <div class="col-md-4">
              <div class="thumbnail team__single">
                <div class="bio text-center">
                  ...
                  <h2>Sistem Informasi Penyewaan<br>Alat Camping</h2>
                </div>
                <div class="caption">
                  <h4>Sistem informasi peralatan camping menyediakan penyewaan alat camping yang berkualitas</h4>
                  <div class="social-icons">
                    <li><a href="#"><i class="flaticon-facebook-letter-logo"></i></a></li>
                    <li><a href="#"><i class="flaticon-twitter-logo-silhouette"></i></a></li>
                    <li><a href="#"><i class="flaticon-google-plus"></i></a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 footer__left">
            <h3 style="color: aliceblue;">|| Seping</h3>
            <p>Copyright <span>&copy;</span> Group Four of Cloud Computing 2020</p>
          </div>
