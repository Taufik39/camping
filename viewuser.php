  ...
  ?>
          ...
          <?php
              ...
              <?php echo "<img style='height: 200px; width: 300px;' src='img/$row[foto]'/>";?>
                ...
                <center><a href='formpemesan.php?barang=<?php echo $row['nama_barang']; $_SESSION['id_barang'] = $row['id_barang']; 
                $_SESSION['pemilik'] = $row['pemilik']; ?>'><button>PESAN</button></a></center>
							</ul>
					  	</div>
					</div>
				</div>
